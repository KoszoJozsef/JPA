...
<body>
	...
	<form method="POST" action="AddFlight">
		...
		<input name="model_name" type="text"></input>
	...
	<form method="POST" action="CreatePilotToFlight">
	...
	<form method="POST" action="AddTicketToPassenger">
		...
		<button type="submit">Add flight ticket to passenger</button>
