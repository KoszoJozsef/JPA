...
public class PassengersWebService {
	...
	@Produces(MediaType.APPLICATION_XML)
	@Path("{passenger_id}")
	public Passenger getPassenger(@PathParam("passenger_id") int passengerId ){
	...
	public Response updatePassanger(@PathParam("pId") int passengerId, Passenger pUpdated){
	...
	@Path("/edit2/{pId}")
	@Consumes("application/json")
	public Response updatePassanger2(@PathParam("pId") int passengerId, Passenger pUpdated){
